        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Purok Registration Form</h2>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-row ">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    ...
                                    <div class="col-1">
                                        <div class="input-group-desc">
                                            <input disabled class="input--style-5 " pattern="[A-Za-z]+" placeholder="Area Count" type="text" name="">

                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <input disabled class="input--style-5" pattern="[A-Za-z]+" placeholder="Status" type="text" name="">
                                        </div>
                                    </div>
                                </div>
                            </div>
