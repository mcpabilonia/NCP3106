            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" name="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return checkValidates()" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter first name">
                        <input disabled class="input100" type="text" name="admin_first_name" placeholder="First Name" required>
                        <span class="focus-input100" data-placeholder="&#xf207;"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Enter last name">
                        <input disabled class="input100" type="text" name="admin_last_name" placeholder="Last Name" required>
                        <span class="focus-input100" data-placeholder="&#xf207;"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Enter middle name">
                        <input disabled class="input100" type="text" name="admin_middle_name" placeholder="Middle Name" required>
                        <span class="focus-input100" data-placeholder="&#xf207;"></span>
                    </div>
