        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Official Barangay Registration Form</h2>
                </div>
                <div class="card-body">
                    <form name="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return checkValidates()" method="post">
                        ...
                        <!-- RESIDENT TYPE-->
                        <div class="form-row">
                            <div class="name">Barangay Position</div>
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-1">
                                        <div class="input-group" style="width: 495px; padding-left: 15px;">
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select required name="resident_type">
                                                    ...
                                                    <option>Barangay Court</option>
                                                    <option>Youth Council</option>
                                                    <option>Committee</option>
                                                    <option>Council</option>
                                                    <option>Disaster Coordinating Committee</option>
                                                    <option>Nutrition Council</option>
                                                    <option>Tanod</option>
                                                    <option>Anti-Drug Addiction Committee</option>
                                                    <option>Solid Waste Management Committee</option>
                                                    <option>Physical Fitness Sports Devt. Council</option>
                                                    <option>Technical Working Group Committee</option>
                                                    <option>Children Protection Council</option>
                                                    <option>HR Action Officer</option>
                                                </select>
                                                <div class="select-dropdown"></div>
                                            </div>
                                        </div>
